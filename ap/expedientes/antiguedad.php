<?php $data_archivo = $Folios->getListadoFoliosArchivo('antiguedad.php');?>
...
<?php foreach($data_archivo as $data):?>
  ...
  <div class="form-group col-sm-6" id="div_<?php echo $data['nom_variable']."_".$data['id_tipdoc'];?>">
        ...
        <?php if(isset($values['id_persona']) and $values['id_persona']!=''):?>
            ...
            <?php $listado_archivos = $ExpedientesDetalles->getDocumentosExpedienteArchivo($values['id_persona'],'antiguedad.php',$data['id_folio'],$data['id_tipdoc']);?>
