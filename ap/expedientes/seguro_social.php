<?php $data_archivo = $Folios->getListadoFoliosArchivo('seguro_social.php');?>
...
<?php foreach($data_archivo as $data):?>
  ...
  <div class="form-group col-sm-6" id="div_<?php echo $data['nom_variable']."_".$data['id_tipdoc'];?>">
        ...
        <?php if(isset($values['id_persona']) and $values['id_persona']!=''):?>
            ...
            <?php $listado_archivos = $ExpedientesDetalles->getDocumentosExpedienteArchivo($values['id_persona'],'seguro_social.php',$data['id_folio'],$data['id_tipdoc']);?>
