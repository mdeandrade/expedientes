...
<div class="container">
	...
	<table id="example" class="table table-striped table-bordered table-responsive" width="100%" cellspacing="0">
			...
			<tfoot>
				<tr>
					<th><input id="idPoliza" name="id_ubicaciones" type="text"></th>
                                        <th><input id="NumPoliza" name="nom_ubicacion" type="text"></th>
	...
	<a class="btn btn-success"  href="<?php echo full_url."/ap/Ubicaciones/index.php?action=new"?>"><i class="fa fa-file-o fa-pull-left fa-border"></i> Agregar</a>
</div>
